...
function CreateOrder() {
  ...
  if (cartQuantity === 0) return <EmptyCart />;
  return (
      ...
      <Form method="POST">
        ...
        <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {formErrors?.phone && (
              <p className="ml-2 mt-2 w-fit rounded-lg bg-red-200 px-3 py-1 text-sm font-semibold text-red-700">
                {formErrors.phone}
              </p>
            )}
          </div>
...
export async function action({ request }) {
  ...
  if (!isValidPhone(newOrder.phone))
    errors.phone = "plz enter your valid phone number";
